---
title: "Experiments 210-11"
author: "Erik J Peterson"
date: "April 29, 2016"
output: html_document
---

```{r helper_fns, warning=FALSE, message=FALSE}
library(ggplot2)
library(grid)
library(gridExtra)
library(plyr)
...
iters <- 0:999
ping <- NULL
ping_path <- paste(path, "/exp210/", sep="/")
for(i in iters){
  tmp <- rbind(
...
iters <- 0:999
ing <- NULL
ing_path <- paste(path, "/exp211/", sep="/")
for(i in iters){
  tmp <- rbind(
...
# ping %>%
#   mutate(
#     fid_rate = 1 - (ping$lev_course_rate_e / max(ping$lev_course_rate_e)),
#     fid_spike = 1 - (ping$lev_spike_e / max(ping$lev_spike_e)),
...
ping_rank <- select(ping[order(ping$pow_mean_n), ], pow_mean, pow_mean_n, w_e, w_i, w_ei, w_ie, w_ee, w_ii, e_ratio, ie_ratio)

ing_rank <- select(ing[order(ing$pow_mean_n), ], pow_mean, pow_mean_n, w_e, w_i, w_ei, w_ie, w_ee, w_ii, e_ratio, ie_ratio)
...
# PING
ping %>%
  ggplot(aes(x=pow_mean_n, y=s_sync_e)) +
  geom_point() +
  theme_classic() ->
  pow1

ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_spike_e_n)) +
  geom_point() +
  theme_classic() ->
  pow2

ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_course_rate_e_n)) +
  geom_point() +
  theme_classic() ->
  pow3

ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_spike_e)) +
  geom_point() +
  theme_classic() ->
  pow4

ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_fine_rate_e)) +
  geom_point() +
  theme_classic() ->
  pow5
...
ing %>%
  ggplot(aes(x=pow_mean_n, y=lev_fine_rate_e_n)) +
  geom_point() +
  theme_classic() ->
  pow8
...
# PING
ping %>%
  ggplot(aes(x=factor(ie_ratio), y=s_sync_e)) +
  geom_boxplot() +
  theme_classic() ->
  ieei1

ping %>%
  ggplot(aes(x=factor(ie_ratio), y=lev_spike_e_n)) +
  geom_boxplot() +
  theme_classic() ->
  ieei2

ping %>%
  ggplot(aes(x=factor(ie_ratio), y=lev_course_rate_e_n)) +
  geom_boxplot() +
  theme_classic() ->
  ieei3

ping %>%
  ggplot(aes(x=factor(ie_ratio), y=kl_spike_e)) +
  geom_boxplot() +
  theme_classic() ->
  ieei4

ping %>%
  ggplot(aes(x=factor(ie_ratio), y=kl_fine_rate_e)) +
  geom_boxplot() +
  theme_classic() ->
  ieei5
...
# PING
ping %>%
  ggplot(aes(x=factor(e_ratio), y=s_sync_e)) +
  geom_boxplot() +
  theme_classic() ->
  we1

ping %>%
  ggplot(aes(x=factor(e_ratio), y=lev_spike_e_n)) +
  geom_boxplot() +
  theme_classic() ->
  we2

ping %>%
  ggplot(aes(x=factor(e_ratio), y=lev_fine_rate_e_n)) +
  geom_boxplot() +
  theme_classic() ->
  we3

ping %>%
  ggplot(aes(x=factor(e_ratio), y=kl_spike_e)) +
  geom_boxplot() +
  theme_classic() ->
  we4

ping %>%
  ggplot(aes(x=factor(e_ratio), y=kl_fine_rate_e)) +
  geom_boxplot() +
  theme_classic() ->
  we5
...
# w_e
ping %>%
  ggplot(aes(x=pow_mean_n, y=s_sync_e, color=w_e/min(w_e))) + 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_spike_e_n, color=w_e/min(w_e))) + 
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_course_rate_e_n, color=w_e/min(w_e))) +
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_spike_e, color=w_e/min(w_e))) + 
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_course_rate_e, color=w_e/min(w_e))) +
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
# --
ping %>%
  ggplot(aes(x=pow_mean_n, y=s_sync_e, color=w_ie/w_ei)) + 
  geom_point(alpha=0.1) +  
  theme_classic() + 
  scale_color_continuous() + 
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_spike_e_n, color=w_ie/w_ei)) + 
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() + 
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_course_rate_e_n, color=w_ie/w_ei)) + 
  geom_point(alpha=0.1) +  
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_spike_e, color=w_ie/w_ei)) + 
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() + 
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_course_rate_e, color=w_ie/w_ei)) + 
  geom_point(alpha=0.1) +
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
# w_e
ping %>%
  ggplot(aes(x=pow_mean_n, y=s_sync_e, color=factor(e_ratio))) + 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_spike_e_n, color=factor(e_ratio))) + 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_course_rate_e_n, color=factor(e_ratio))) +
  stat_smooth(alpha=0.2) + 
  theme_classic() + 
  scale_color_brewer(palette="YlGnBu") +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_spike_e, color=factor(e_ratio))) + 
  stat_smooth(alpha=0.2) + 
  theme_classic() + 
  scale_color_brewer(palette="YlGnBu") +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_course_rate_e, color=factor(e_ratio))) +
...
# --
ping %>%
  ggplot(aes(x=pow_mean_n, y=s_sync_e, color=factor(ie_ratio))) + 
  stat_smooth(alpha=0.2) +  
  theme_classic() + 
  scale_color_brewer(palette="YlGnBu") + 
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_spike_e_n, color=factor(ie_ratio))) + 
  stat_smooth(alpha=0.2) + 
  theme_classic() + 
  scale_color_brewer(palette="YlGnBu") + 
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=lev_course_rate_e_n, color=factor(ie_ratio))) + 
  stat_smooth(alpha=0.2) +  
  theme_classic() + 
  scale_color_brewer(palette="YlGnBu") +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_spike_e, color=factor(ie_ratio))) + 
  stat_smooth(alpha=0.2) + 
  theme_classic() + 
  scale_color_brewer(palette="YlGnBu") + 
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=pow_mean_n, y=kl_course_rate_e, color=factor(ie_ratio))) + 
  stat_smooth(alpha=0.2) +
  theme_classic() + 
  scale_color_brewer(palette="YlGnBu") +
  theme(legend.position="none") -> 
...
# w_e
ping %>%
  ggplot(aes(x=w_e/min(w_e), y=s_sync_e, color=pow_mean_n)) + 
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=w_e/min(w_e), y=lev_spike_e_n, color=pow_mean_n)) + 
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=w_e/min(w_e), y=lev_course_rate_e_n, color=pow_mean_n)) +
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=w_e/min(w_e), y=kl_spike_e, color=pow_mean_n)) + 
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=w_e/min(w_e), y=kl_course_rate_e, color=pow_mean_n)) +
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
# --
ping %>%
  ggplot(aes(x=w_ie/w_ei, y=s_sync_e, color=pow_mean_n)) + 
  geom_point(alpha=0.1) +  
  theme_classic() + 
  scale_color_continuous() + 
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=w_ie/w_ei, y=lev_spike_e, color=pow_mean_n)) + 
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() + 
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=w_ie/w_ei, y=kl_spike_e, color=pow_mean_n)) + 
  geom_point(alpha=0.1) + 
  theme_classic() + 
  scale_color_continuous() + 
  theme(legend.position="none") -> 
...
ping %>%
  ggplot(aes(x=w_ie/w_ei, y=kl_fine_rate_e, color=pow_mean_n)) + 
  geom_point(alpha=0.1) +
  theme_classic() + 
  scale_color_continuous() +
  theme(legend.position="none") -> 
...
# PING
ping %>%
  ggplot(aes(x=ie_ratio, y=e_ratio, fill=s_sync_e)) +
  geom_raster() +
  theme_classic() +
...
ping %>%
  ggplot(aes(x=ie_ratio, y=e_ratio, fill=lev_spike_e)) +
  geom_tile() +
...
ping %>%
  ggplot(aes(x=ie_ratio, y=e_ratio, fill=lev_course_rate_e)) +
  geom_tile() +
  scale_fill_gradient(low = "white", high = "brown") +
  theme_classic() ->
  parpar3
